...
class IndexInfo(Base, TimestampMixin):
    ...
    index_type: Mapped[str | None] = mapped_column(String(20), comment="指数类型")
    category: Mapped[str | None] = mapped_column(String(20), comment="指数类别")
    ...
    exp_date: Mapped[date | None] = mapped_column(comment="终止日期")
